...
const uchiRouter=require ('./routes/naruto')
class Server {
    constructor(){
        ...
        this.uchiPath = `${this.basePath}/naruto`;//Path para la tabla users
    ...
    routes(){
        this.app.use(this.uchiPath, uchiRouter); //EndPoint de users
    }
